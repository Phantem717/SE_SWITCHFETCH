    ...
    return (
        <div className={`${flexBetween} flex items-center`}>
            <div className={`${flexBetween} text-black `}>
                <input type='text' className={`hover:placeholder:text-black hover:rounded-tl-md hover:rounded-bl-md transition-all duration-100 hover:border-2 hover:border-black placeholder:pl-2 rounded-tl-sm rounded-bl-sm w-96 h-8`} placeholder='Cari Produk' 
