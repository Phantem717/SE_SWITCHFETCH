...
const ProdInfoBox = () => {
 ...
 <div className=''>
     ...
     <div className='flex flex-row items-center mt-6'>
          <div className='font-semibold text-6xl flex justify-start'>
            George Robe
          </div>
    
          <div className='flex flex-row items-center text-gray-400 font-medium text-3xl ml-auto'>
            4.96
      ...
      {/* Price */}
      <div className='mt-6 text-4xl font-semibold mb-6'>
        Rp. 42.069
      </div>
    ...
    <QTYIncrement />
      ...
      <div className='font-semibold text-3xl ml-2'>
        Rp124.313
      </div>
    </div>
