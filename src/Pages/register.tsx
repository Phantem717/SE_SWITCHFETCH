...
const signUp = () => {
  ...
  return (
    <div className={'bg-cover h-screen bg-gradient-to-r from-logregGrad5 to-logregGrad6'} style= {{backgroundImage: `url(${background})`}}>
        ...
        <div className={`${flexCent} shadow-xl bg-gradient-to-r from-logregGrad1/50 from-25% via-logregGrad1.5/50 via-50% to-logregGrad2/50 to-77% rounded-tl-lg rounded-bl-lg h-4/6 w-4/12`}>
          <img src={logo} alt="" className={`h-3/4`}/>
          </div>
            <div className={`shadow-xl bg-gradient-to-b from-logregGrad3/50 from-0% via-logregGrad4/50 via-41% to-loregGrad4.5/50 to-100% rounded-tr-lg rounded-br-lg h-4/6 w-3/12 p-12 bg-o `}>
              <h1 className={`${flexCent} text-3xl font-bold`}>Register</h1>
              ...
              <div className={`text-xs mt-10`}>
                <p className={`${flexCent} text-logregnoAcc`}>Have account already?</p>
